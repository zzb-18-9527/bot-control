...
u32 AM_ADC_Channel4_Sample = 0 ;	// ADC通道4采样总计
	
u16 AV_ADC_Channel1_Sample = 2047 ;	// ADC_CH1平均值（设置初值为中间位置）
u16 AV_ADC_Channel2_Sample = 2047 ;	// ADC_CH2平均值（设置初值为中间位置）
u16 AV_ADC_Channel3_Sample = 2047 ;	// ADC_CH3平均值（设置初值为中间位置）
u16 AV_ADC_Channel4_Sample = 2047 ;	// ADC_CH4平均值（设置初值为中间位置）
...
void ADC1_Rocker_Init(void)
{
	...
	// 配置ADC1_CH1、ADC1_CH2、ADC1_CH3、ADC1_CH4
	...
	ADC_RegularChannelConfig(ADC1, N_ADC_Channel_4, 4, ADC_SampleTime_239Cycles5);
...
void ADC1_Value_average(void)
{
	...
	AM_ADC_Channel3_Sample += ADC1_Value[C_ADC_Sample][2];	// 得到
		
	AM_ADC_Channel4_Sample += ADC1_Value[C_ADC_Sample][3];
	...
	{ 
		...
		AV_ADC_Channel4_Sample = AM_ADC_Channel4_Sample / C_Channel_Sample;		// 求通道4的平均值
